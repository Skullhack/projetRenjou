...
public class IAFacile extends IA {
	...
	private Coordonnees coordonneesDunAlignementATroisPoints(Coordonnees p, TypeDirection typeDirection, PlateauDeJeu plateau){
		Coordonnees c = new Coordonnees(-1,-1);
		...
		switch(typeDirection){
			case Bas:
				...
				else if(( p.getLigne() + 3 < nbLigne) &&(caseJouable(new Coordonnees(p.getLigne()+3, p.getColonne()), plateau))){
			...
			case Droite:
				...
				int testLigne = p.getLigne();
				int testColonne = p.getColonne()+3;
				System.out.println(testLigne + " " + testColonne + "    " + nbColonne);
				...
				else if(( p.getColonne() + 3 < nbColonne) &&(caseJouable(new Coordonnees(p.getLigne(), p.getColonne()+3), plateau))){
			...
			case DiagonaleBasDroite:
				...
				if((p.getLigne() - 1 > 0) && (p.getColonne() -1 > 0) && (caseJouable(new Coordonnees(p.getLigne()-1, p.getColonne()-1), plateau))){
					return (new Coordonnees(p.getLigne() - 1,p.getColonne() - 1));
				}
				//on test le point en bas a droite
				else if(( p.getLigne() + 3 < nbLigne) && ( p.getColonne() + 3 < nbColonne) &&(caseJouable(new Coordonnees(p.getLigne()+3, p.getColonne()+3), plateau))){
			...
			case DiagonaleBasGauche :
				...
				if((p.getLigne() - 1 > 0) && (p.getColonne() + 1 < nbColonne) && (caseJouable(new Coordonnees(p.getLigne()-1, p.getColonne()+1), plateau))){
					return (new Coordonnees(p.getLigne() - 1,p.getColonne() + 1));
				}
				//on test le point en bas a gauche
				else if(( p.getLigne() + 3 < nbLigne) && ( p.getColonne() - 3 > 0) &&(caseJouable(new Coordonnees(p.getLigne()+3, p.getColonne()-3), plateau))){
					return (new Coordonnees(p.getLigne() + 3,p.getColonne() - 3));
				}
