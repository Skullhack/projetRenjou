...
public class ComposantAffichageTabou extends JPanel implements ActionListener {
	...
	// ImageIcon img1 = new ImageIcon(new
	// ImageIcon("src/Images/Tabous/"+m.getRenjou().getTabouJeu().get(0+decalage).getNom()+"Image.png").getImage().getScaledInstance(70,
	// 70, java.awt.Image.SCALE_SMOOTH));
	// if (img1 != null)
	// affichages[0].setIcon(img1);
	// }
	// if ((m.getRenjou().getTabouJeu().get(1+decalage)) != null) {
	// ImageIcon img2 = new ImageIcon(new
	// ImageIcon("src/Images/Tabous/"+m.getRenjou().getTabouJeu().get(1+decalage).getNom()+"Image.png").getImage().getScaledInstance(70,
	// 70, java.awt.Image.SCALE_SMOOTH));
	// if (img2 != null)
	// affichages[1].setIcon(img2);
	// }
	// if ((m.getRenjou().getTabouJeu().get(1+decalage)) != null) {
	// ImageIcon img3 = new ImageIcon(new
	// ImageIcon("src/Images/Tabous/"+m.getRenjou().getTabouJeu().get(2+decalage).getNom()+"Image.png").getImage().getScaledInstance(70,
	// 70, java.awt.Image.SCALE_SMOOTH));getInsets();
	// if (img3 != null)
